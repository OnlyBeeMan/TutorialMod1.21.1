...
public class ModItemGroups {
    ...
    public static final ItemGroup PINL_GARNET_ITEMS_GROUP = Registry.register(Registries.ITEM_GROUP,
    ...
    public static final ItemGroup PINL_GARNET_BLOCKS_GROUP = Registry.register(Registries.ITEM_GROUP,
